"""Nodes for the interview agent graph.

Each function is a LangGraph node: it takes the ``InterviewState`` and returns
the next state. Graph wiring lives in ``app.graphs.interview_graph``.
"""
